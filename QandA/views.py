...
def home(request):
            ...
            with connection.cursor() as cursor:
                ...
                for (id,title,que,tags,count,oname,cdate,ldate,lname) in ques:
                    if(oname!=None and cdate != None and ldate !=None):
                        c = '<h3>'+title+'</h3>'+'<br>'+f'<div id="upvotes">(upvotes:{count})</div>'+f'(Post by <b>{oname}</b>)'+f'(Posted on <b>{cdate}</b>)'+f'(Last edited on <b>{ldate}</b>)'+'<br>'+'<u><b>Question:</b></u>'+f'<b>{que}</b><br>'+f'<a href="/question/{id}" class="link-primary"><button type="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="">View Answers</button></a><hr>'
                    else:
                        c = '<h3>'+title+'</h3>'+'<br>'+f'<div id="upvotes">(upvotes:{count})</div>'+'<br>'+'<u><b>Question:</b></u>'+f'<b>{que}</b><br>'+f'<a href="/question/{id}" class="link-primary"><button type="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="">View Answers</button></a><hr>'
    ...
    with connection.cursor() as cursor:
        ...
        for (id,title,que,tags,count,oname,cdate,ldate,lname) in ques:
            if(oname!=None and cdate != None and ldate !=None):
                c = '<h3>'+title+'</h3>'+'<br>'+f'<div id="upvotes">(upvotes:{count})</div>'+f'(Posted on <b>{cdate}</b>)'+f'(Last edited on <b>{ldate}</b>)'+'<br>'+'<u><b>Question:</b></u>'+f'<b>{que}</b><br>'+f'<a href="/question/{id}" class="link-primary"><button type="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="">View Answers</button></a>'+f'<a href="/edit/{id}" class="link-primary"><button type="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="">Edit</button></a>'+f'<a href="/delete/{id}"><button type="submit" class="btn btn-danger btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="post">Delete</button></a>"'+'<hr>'
                
            else:
                c = '<h3>'+title+'</h3>'+'<br>'+f'<div id="upvotes">(upvotes:{count})</div>'+'<br>'+'<u><b>Question:</b></u>'+f'<b>{que}</b><br>'+f'<a href="/question/{id}" class="link-primary"><button type="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="">View Answers</button></a>'+f'<a href="/edit/{id}" class="link-primary"><button type="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="">Edit</button></a>'+f'<a href="/delete/{id}"><button type="submit" class="btn btn-danger btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="post">Delete</button></a>"'+'<hr>'
        ...
        for (id,title,body,tags,count,oname,cdate,ldate,lname) in posts:
            if(title==None):
                if(lname!=None):
                    c = f'<div id="upvotes">(upvotes:{count})</div>'+f'(Posted on <b>{cdate}</b>)'+f'(Last edited by <b>{lname}</b>)'+'<br>'+f'<div>{str(body)}</div>'+f'<a href="/edit/{id}" class="link-primary"><button type="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="">Edit</button></a>'+f'<a href="/delete/{id}"><button type="submit" class="btn btn-danger btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="post">Delete</button></a>"'+'<hr>'
                else:
                    c = f'<div id="upvotes">(upvotes:{count})</div>'+f'(Posted on <b>{cdate}</b>)'+'<br>'+f'<div>{str(body)}</div>'+f'<a href="/edit/{id}" class="link-primary"><button type="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="">Edit</button></a>'+f'<a href="/delete/{id}"><button type="submit" class="btn btn-danger btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="post">Delete</button></a>"'+'<hr>'
            else: 
                if(lname!=None):
                    c = '<b>'+str(title)+'</b>'+'<br>'+f'<div id="upvotes">(upvotes:{count})</div>'+f'(Posted on <b>{cdate}</b>)'+f'(Last edited by <b>{lname}</b>)'+'<br>'+f'<div>{str(body)}</div><br>'+f'<a href="/edit/{id}" class="link-primary"><button type="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="">Edit</button></a>'+f'<a href="/delete/{id}"><button type="submit" class="btn btn-danger btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="post">Delete</button></a>"'+'<hr>'
                else:
                    c = '<b>'+str(title)+'</b>'+'<br>'+f'<div id="upvotes">(upvotes:{count})</div>'+f'(Posted on <b>{cdate}</b>)'+'<br>'+f'<div>{str(body)}</div><br>'+f'<a href="/edit/{id}" class="link-primary"><button type="submit" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="">Edit</button></a>'+f'<a href="/delete/{id}"><button type="submit" class="btn btn-danger btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem;" name="post">Delete</button></a>"'+'<hr>'
            content.append(c)
...
def edit(request,id):
    ...
    if(request.method=='POST'):
        ...
        try:
            with connection.cursor() as cursor:
                cursor.execute(f'''Update posts set title='{title}',body='{body}',tags='{tags}' where id={id};''')
        except:
            None
...
def question(request,id):
    ...
    with connection.cursor() as cursor:
        ...
        if(oname!=None and cdate != None and ldate !=None):
            question = '<h3>'+title+'</h3>'+f'<div id="upvotes">(upvotes:{count})</div>'+f'(Post by <b>{oname}</b>)'+f'(Posted on <b>{cdate}</b>)'+f'(Last edited on <b>{ldate}</b>)'+'<br>'+'<u><b>Question:</b></u>'+f'<b>{body}</b><br>'
        else:
            question = '<h3>'+title+'</h3>'+f'<div id="upvotes">(upvotes:{count})</div>'+'<br>'+'<u><b>Question:</b></u>'+f'<b>{body}</b><br>'
        ...
        for (body,up,aname,adate,ldate2) in ans:
            ...
            if(aname != None and adate != None and ldate2 != None):
                c = f'<u><b>Answer-{i}:</b></u>'+ f' (upvotes:{up})' + f'(Answered by <b>{aname}</b> on <b>{adate}</b>)'+f'(Last edited on <b>{ldate2}</b>)<br>'+body+'<br>'
            else:
                c = f'<u><b>Answer-{i}:</b></u>'+ f' (upvotes:{up})' + '<br>'+body+'<br>'
            i += 1
            content.append(c)
...
def answer(request,id):
    ...
    if(request.method=='POST'):
        ...
        with connection.cursor() as cursor:
            ...
            try:
                cursor.execute(f'''Select id from posts where body='{body}' and owner_user_id={userid_global} and parent_id={id} ''')
                aid = cursor.fetchone()
                cursor.execute(f'''Insert into v(post_id,count) values({aid[0]},0)''')
            except:
...
def Login(request):
    ...
    if(request.method=='POST'):
        ...
        with connection.cursor() as cursor:
            cursor.execute(f"Select password from users where id={userid} and display_name='{username}';")
...
def create_post(request):
    ...
    if(request.method=='POST'):
        ...
        with connection.cursor() as cursor:
            ...
            try:
                cursor.execute(f'''Select id from posts where body='<p>{que}</p>' and owner_user_id={userid_global} ''')
                aid = cursor.fetchone()
                cursor.execute(f'''Insert into v(post_id,count) values({aid[0]},0)''')
            except:
